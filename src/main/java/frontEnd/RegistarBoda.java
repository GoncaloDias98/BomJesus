 ...
 * @author gonca
 */
public class RegistarBoda extends javax.swing.JFrame {
...
/**
    ...
    private void botaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoActionPerformed
        try {
            ...
            Logger.getLogger(RegistarBoda.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
  ...
  void postDB() throws Exception{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistarBoda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistarBoda().setVisible(true);
            }
        });
    }
