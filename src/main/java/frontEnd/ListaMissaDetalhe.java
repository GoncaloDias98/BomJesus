 ...
 * @author gonca
 */
public class ListaMissaDetalhe extends javax.swing.JFrame {

    /**
     * Creates new form ListaMissaDetalhe
     */
    public ListaMissaDetalhe() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaMissaDetalhe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaMissaDetalhe().setVisible(true);
            }
        });
    }
