 ...
 * @author gonca
 */
public class RegistarViaSacra extends javax.swing.JFrame {
private Inicio inicio;

    /**
     * Creates new form RegistarMissaa
     */
    public RegistarViaSacra() {
...
/**
    ...
    private void botaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoActionPerformed
        try {
            ...
            Logger.getLogger(RegistarViaSacra.class.getName()).log(Level.SEVERE, null, ex);
        }
        dispose();
  ...
  void postDB() throws Exception{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistarViaSacra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistarViaSacra().setVisible(true);
            }
        });
    }
